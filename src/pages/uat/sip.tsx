    ...
    return (
        ...
        <div className={styles.gridContainer}>
            <div className={styles.gridItem}>
                ...
                <p className={ styles.hangingIndent }>The Directional Alarm Clock is a user-specific method of alerting users with the use of an ultrasound speaker to direct the alarm towards the specific sleeper who needs to be woken up without disturbing other sleepers nearby.
                </p>
            </div>
            ...
            <div className={styles.gridItem}>
                ...
                <p className={ styles.hangingIndent }>This alarm clock will use an ultrasound speaker for directional audio to target a specific person, so only the person using the alarm will be awoken. Along with directional audio, the clock will require the completion of a task to disable the alarm clock to activate the brain and get the user ready for the day.
                </p>
            </div>
        </div>
